    ...
    <div class="page-container form-page">
      ...
      <form class="event-form card" @submit.prevent>
        <div class="card-body">
          ...
          <div class="form-group">
            <label class="form-label">Event Picture (Banner)</label>
          ...
          <div class="form-group">
            <label class="form-label">Event Posters (Multiple allowed)</label>
            <div class="poster-upload-wrapper">
              ...
              />
              <div v-if="form.posters && form.posters.length" class="posters-grid">
                <div v-for="(poster, index) in form.posters" :key="index" class="poster-item">
                  <div class="poster-thumbnail-container">
                    <img :src="poster.url" :alt="poster.name" class="poster-thumbnail" />
                    <button type="button" class="btn btn-danger btn-sm remove-poster-btn" @click="removePoster(index)">
                      &times; Remove
                    </button>
                  </div>
